...
This codebase has been deprecated in favor of upstream aks-engine. Latest release binaries from https://github.com/Azure/aks-engine can be used to perform Kubernetes cluster operations.
